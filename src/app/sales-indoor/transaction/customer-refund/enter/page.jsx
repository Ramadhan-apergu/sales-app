  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      payloadToInsert = {
        ...
        creditmemoid: form.getFieldValue("creditmemo"),
        creditmemonum: creditMemoSelected?.tranid || "",
      };
      ...
      const response = await CustomerRefundFetch.create(payloadToInsert);

      const resData = createResponseHandler(response, notify);

      if (resData) {
        router.push(`/sales-indoor/transaction/customer-refund/${resData}`);
      }
    } catch (error) {
