  ...
  const [payloadGroup, setPayloadGroup] = useState({
    ...
    const dataInput = [
        [
            ...
            {key: "qtyminunit", input: 'input', isAlias: true, rules: [{required: true, message: 'is required!'}], disabled: true},
            {key: "qtymax", input: 'number', isAlias: true, rules: [{required: true, message: 'is required!'}]},
            {key: "qtymaxunit", input: 'input', isAlias: true, rules: [{required: true, message: 'is required!'}], disabled: true},
