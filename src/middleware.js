...
export async function middleware(request) {
  ...
  if (!access_token || !role || !role_token) {
  ...
  const matchedPrefix = PROTECTED_ROUTES.find((route) =>
  ...
  if (matchedPrefix) {
    const roleMap = {
      ...
      "/sales-outdoor": "sales-outdoor",
      "/accounting": "accounting",
      "/finance": "finance",
    };

    const userGroup = roleMap[matchedPrefix] || "sales-outdoor";
