...
import { HiOutlineTicket, HiCalendarDays, HiOutlineLightBulb } from "react-icons/hi2";
            ...
            <div className="w-full h-auto rounded-xl bg-white px-4 py-3 flex flex-col gap-2 shadow">
                <div className="flex justify-between items-center w-full">
                    <div className="flex gap-2 items-center">
                        ...
                        <p className="text-sm font-semibold">{data?.targetid || '-'}</p>
                    </div>
                    <div className="flex gap-2 items-center">
                        <p className="text-sm font-semibold">{data?.totaltarget || '-'}</p>
                        <FaCrosshairs className="text-blue-6"/>
                    </div>
                </div>
                <div className="h-full flex flex-col justify-between">
                    <div className="bg-gray-3 p-2 rounded border border-gray-5 flex justify-center px-2">
                        <div className="w-full h-full flex flex-col justify-left items-start">
                            <p className="text-xs text-gray-12/70">Description</p>
                            <p className="text-sm truncate w-full">{data?.description || '-'}</p>
                        </div>
                    </div>
                </div>
